import 'package:ecommerce/controller/authcontroller/verifycodesignupcontroller.dart';
...
class VerifyCodeSignUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(VerifyCodeSignUpControllerIm());
    ...
    return Scaffold(
        ...
        body: GetBuilder<VerifyCodeSignUpControllerIm>(
